<template>
  ...
  >
    ...
    <div class="z-10 absolute" :class="positionOuterClasses(position)">
      ...
      >
        <div
          v-show="tooltipOpen" class="rounded overflow-hidden dark:bg-slate-800 dark:border-slate-800 bg-white border border-slate-200 shadow-lg"
          :class="[
            sizeClasses(size),
...
export default {
  name: 'Tooltip',
  props: ['bg', 'size', 'position', 'canclick'],
  methods: {
    handleClick(event) {
